...
print(ROOT_DIR)
SHAPE_NAMES = [line.rstrip() for line in \
    open(os.path.join(ROOT_DIR, 'data/modelnet40_normal_resampled/modelnet10_shape_names.txt'))] 
...
if FLAGS.normal:
    ...
    TEST_DATASET = modelnet_dataset.ModelNetDataset(root=DATA_PATH, npoints=NUM_POINT, split='test', batch_size=BATCH_SIZE, modelnet10=True, shuffle=False)
...
def eval_one_epoch(sess, ops, num_votes=1, topk=1):
    ...
    print("NUM BATCHES: ", TEST_DATASET.num_batches)
    ...
    while TEST_DATASET.has_next_batch():
        ...
        for vote_idx in range(num_votes):
            ...
            print('Batch Pred Sum Shape: ', batch_pred_sum.shape)
